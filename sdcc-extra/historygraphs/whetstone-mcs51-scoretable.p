...
datafile = "whetstone-mcs51-scoretable"

# Configure arrow length (to make the plot look nice)
arrowlength = 1

set arrow from 9618, 955.109+arrowlength to 9618, 955.109
set label "3.6.0" at 9618, 955.109+arrowlength
...
set arrow from 15246, 962.463+arrowlength to 15246, 962.463
set label "4.5.0" at 15246, 962.463+arrowlength
set arrow from 16640, 967.117+arrowlength to 16640, 967.117
set label "4.6.0" at 16640, 967.117+arrowlength
