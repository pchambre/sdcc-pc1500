...
set arrow from 9256, 106+arrowlength to 9256, 106 front
set label "3.5.0" at 9256, 106+arrowlength front
set arrow from 9618, 108+arrowlength to 9618, 108 front
set label "3.6.0" at 9618, 108+arrowlength front
set arrow from 10233, trans(204)+arrowlength to 10233, trans(204)
set label "3.7.0" at 10233, trans(204)+arrowlength
...
set arrow from 13131, trans(243)+arrowlength to 13131, trans(243)
set label "4.2.0" at 13131, trans(243)+arrowlength
set arrow from 14208, trans(195)+arrowlength to 14208, trans(195)
set label "4.3.0" at 14208, trans(195)+arrowlength
set arrow from 14648, trans(244)+arrowlength to 14648, trans(244)
set label "4.4.0" at 14648, trans(244)+arrowlength
set arrow from 15246, trans(246)+arrowlength to 15246, trans(246)
set label "4.5.0" at 15246, trans(246)+arrowlength
set arrow from 16640, trans(248)+arrowlength to 16640, trans(248)
set label "4.6.0" at 16640, trans(248)+arrowlength
