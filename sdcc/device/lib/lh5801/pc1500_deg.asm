;--------------------------------------------------------------------------
; pc1500_deg.asm - PC-1500 native DEG (single-operand, mutate-in-
; place) math routine, for the LH5801 SDCC port.
;
; Paul Chambre, 2026
;
; ROM address 0xF531 (per the PC-2 Assembly Language manual's memory
...
;--------------------------------------------------------------------------
	...
	.globl _pc1500Deg
	.globl _pc1500Deg_PARM_1
	.globl __pc1500_fp_copyin
	.globl __pc1500_fp_copyout

;-----------------------------------------------------------------
; void pc1500Deg(pc1500_float_t v);
;-----------------------------------------------------------------
_pc1500Deg:
	lda	(_pc1500Deg_PARM_1)
	sta	xh
	lda	(_pc1500Deg_PARM_1 + 1)
	sta	xl
